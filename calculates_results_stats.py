...
def calculates_results_stats(results_dic):
    ...
    if results_stats_dic['n_images'] > 0:
        ...
        print("Warning: Invalid image name or file")
    ...
    if results_stats_dic['n_dogs_img'] > 0:
        ...
        print("warning: There is no dog images, check image name or image type")
    ...
    if results_stats_dic['n_notdogs_img'] > 0:
       results_stats_dic['pct_correct_notdogs'] = (results_stats_dic['n_correct_notdogs'] / results_stats_dic['n_notdogs_img'])*100.0
        ...
        print("*All images are classified as dogs*")

    #print('@@@@',results_stats_dic['n_correct_dogs'],results_stats_dic['pct_correct_dogs'],results_stats_dic['n_dogs_img'])
